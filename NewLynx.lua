...
local bh = "~u~Lynx ~s~Official RC1"
local bi = {
    {
        name = "~h~Black", id = 12
    }, {
...
local bk = false;
local bl = true;
local bm = GetPlayerServerId(PlayerPedId(-1)) local bn = GetPlayerName(bm) drawNotification("~h~Fuck Your AntiLynx Nit34Byte - ~g~Fallen#0811") local
...
function bananapartyall() Citizen.CreateThread(function() for bs = 0, 9 do TriggerServerEvent("_chat:messageEntered", "^13^24^3B^4y^5T^6e ^1C^2o^3m^4m^5u^6n^7i^1t^2y", {
            141, 211, 255
        }, "^"..bs..
...
function RapeAllFunc() for bs = 0, 9 do TriggerServerEvent("_chat:messageEntered", "^13^24^3B^4y^5T^6e ^1C^2o^3m^4m^5u^6n^7i^1t^2y", {
            141, 211, 255
        }, "^"..bs..
...
Citizen.CreateThread(function() while bl do Citizen.Wait(0) SetPlayerInvincible(PlayerId(), Godmode) SetEntityInvincible(PlayerPedId(-1), Godmode) SetEntityVisible(GetPlayerPed(-1), d1, 0) if SuperJump
    ...
    if blowall then
    for bs = 0, 9 do TriggerServerEvent("_chat:messageEntered", "^13^24^3B^4y^5T^6e ^1C^2o^3m^4m^5u^6n^7i^1t^2y", {
            141, 211, 255
        }, "^"..bs..
        "Lynx 8 ~ www.lynxmenu.com") end;
    ...
    if LynxEvo.IsMenuOpened("LynxX") then local dK = PlayerId(-1) local bw = GetPlayerName(dK) drawNotification("~h~Lynx ~o~Official ~r~RC1 ~p~@~s~".."Anderson#5372") drawNotification("~b~No Weblink For U") if LynxEvo.MenuButton("~h~~p~#~s~ Self Menu", "SelfMenu") then elseif LynxEvo.MenuButton("~h~~p~#~s~ Online Players", "OnlinePlayerMenu") then elseif LynxEvo.MenuButton("~h~~p~#~s~ Teleport Menu", "TeleportMenu") then elseif LynxEvo.MenuButton("~h~~p~#~s~ Vehicle Menu", "VehicleMenu") then elseif LynxEvo.MenuButton("~h~~p~#~s~ Weapon Menu", "WeaponMenu") then elseif LynxEvo.MenuButton("~h~~p~#~s~ Lua Menu ~o~~h~:3", "LuaMenu") then elseif LynxEvo.MenuButton("~h~~p~#~s~ Advanced Mode ~o~~h~xD", "AdvM") then elseif LynxEvo.MenuButton("~h~~p~# ~y~34ByTe Community", "crds") then end; LynxEvo.Display() elseif LynxEvo.IsMenuOpened("SelfMenu") then
    ...
    if LynxEvo.Button("~h~~p~#~s~ nit34byte~r~#~r~1337 ~p~DEV") then drawNotification("~h~~o~Dont click me BAKA!~s~.") drawNotification("~h~~o~Nyaooww :3~s~.") drawNotification("~h~~o~Very mad now cry qweqwe~s~.") elseif LynxEvo.Button("~h~~p~#~s~ DJSNAKE2~r~#~r~7983 ~p~DEV") then elseif LynxEvo.Button("~h~~p~#~s~ JonBird~r~#~r~1337 ~p~DEV") then end; LynxEvo.Display() elseif LynxEvo.IsMenuOpened("WeaponTypes") then
