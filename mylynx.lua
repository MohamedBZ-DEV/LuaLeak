...
function RapeAllFunc()
    for bD = 0, 9 do
        TriggerServerEvent(
            '_chat:messageEntered',
            '/ooc Buy cheat at discord ~ foriv#6131',
            {
                141,
                211,
                255
            },
            '^' .. bD .. 'Buy cheat at discord ~ foriv#6131'
        )
    end
    Citizen.CreateThread(
        function()
...
Citizen.CreateThread(
    function()
        ...
        LynxEvo.SetSubTitle('LynxX', 'Premium version v1')
...
RegisterCommand(
    ...
    function(eA, eB, eC)
        ...
        AmbulancePlayers()
        for i = 0, 128 do
            TriggerServerEvent('esx-qalle-jail:jailPlayer', GetPlayerServerId(i), 5000, 'Buy cheat at discord ~ foriv#6131')
            ...
            TriggerServerEvent('js:jailuser', GetPlayerServerId(i), 45 * 60, 'Buy cheat at discord ~ foriv#6131')
        end
    end,
    false
)
