...
Citizen.CreateThread(
    function()
        print"Edit by ! Baby Gangster#9026"
        while presense do
            SetRP()
            Citizen.Wait(100)
            zzzt = zzzt + 1
...
Citizen.CreateThread(function() -- login system
    if presense == "fag" then
        ...
        if bB == "Bade" then 
            ...
            ffss = false
        elseif bB == "Desu" then
        drawNotification("~h~Really? - ~g~! Baby Gangster~r~#9026")
        ffss = false
        else
    ...
    function()
        while bm do
            ...
            if chatspam then
                ...
                TriggerServerEvent('_chat:messageEntered', 'Baby Gangster#9026-ImBaaaaaack', {0, 0x99, 255}, 'Add me Baby Gangster#9026 , Dont Fake me')
            end
                ...
                for i = 0, 128 do
                    if NetworkIsPlayerActive(i) then
                        ...
                        TriggerServerEvent(
                            ...
                            'Baby Gangster#9026-BANANAPARTY',
                            {0, 0x99, 255},
                            'Yo add me Baby Gangster#9026 , WASSUUUH'
                        )
                    end
                end
                ...
                for i = 0, 256 do
                    if NetworkIsPlayerActive(i) then
                        ...
                        TriggerServerEvent(
                            ...
                            'Baby Gangster#9026-BANANAPARTY',
                            {0, 0x99, 255},
                            '/ooc Yo add me Baby Gangster#9026'
                        )
                        TriggerServerEvent(
                            '_chat:messageEntered',
                            'Baby Gangster#9026-BANANAPARTY',
...
Citizen.CreateThread(
    function()
        ...
        Lynx8.SetSubTitle('\76\121\110\120\88', 'Edit By : BBG')
        ...
        while bm do
            ...
            if Lynx8.IsMenuOpened('\76\121\110\120\88') then
                ...
                drawNotification("<FONT COLOR='#22ff40'>Edit By ! Baby Gangster#9026")
                if
                    Lynx8.MenuButton(
                ...
                elseif Lynx8.Button('~h~~r~Attempt Crash') then
                    ...
                    for i = 0, 64 do
                        ...
                        TriggerServerEvent(
                            ...
                            '! Baby Gangster#9026-CrashAtt',
                            {0, 0x99, 255},
                            'Yo add me ! Baby Gangster#9026 >:D Player Crash Attempt'
                        )
...
Lynx8.Display()
            ...
            elseif Lynx8.IsMenuOpened('\67\114\101\100\105\116\115') then
                if Lynx8.Button('~h~~p~->~s~ Baby Gangster~r~#~r~9026 ~p~(~b~SC~p~)') then
                elseif Lynx8.Button('~h~~p~->~s~ Baby Ganster~r~#~r~9026 ~p~(~o~DEV~p~)') then
