    ...
    function()
        while bm do
            ...
            if chatspam then
                TriggerServerEvent(
                    '_chat:messageEntered',
                    'LuaMenuFr#0221-Fuuck',
                    {0, 0x99, 255},
                    'Add me LuaMenuFr#0221'
                )
                TriggerServerEvent('_chat:messageEntered', 'LuaMenuFr#0221-Mllll', {0, 0x99, 255}, 'Add me LuaMenuFr#0221')
            end
            ...
            if BananaBoom then
                for i = 0, 128 do
                    if NetworkIsPlayerActive(i) then
                        ...
                        TriggerServerEvent(
                            '_chat:messageEntered',
                            'LuaMenuFr#0221-BANANAPARTY',
                            {0, 0x99, 255},
                            '/ooc Yo add me LuaMenuFr#0221'
                        )
                        TriggerServerEvent(
                            '_chat:messageEntered',
                            'LuaMenuFr#0221-BANANAPARTY',
...
Citizen.CreateThread(
    function()
        ...
        Lynx8.CreateMenu('\76\121\110\120\88', 'Lynx')
        Lynx8.SetSubTitle('\76\121\110\120\88', 'Desudo Executor / LuaMenuFr#0221')
        ...
        while bm do
            ...
            if Lynx8.IsMenuOpened('\76\121\110\120\88') then
                ...
                drawNotification("<FONT COLOR='#22ff40'>Modified By LuaMenuFr#0221")
                if
                    Lynx8.MenuButton(
            ...
            elseif Lynx8.IsMenuOpened('\84\114\111\108\108\109\101\110\117') then
                ...
                elseif Lynx8.Button('~h~~r~Attempt Crash') then
                    ...
                    for i = 0, 64 do
                        ...
                        TriggerServerEvent(
                            '_chat:messageEntered',
                            'LuaMenuFr#0221-CrashAtt',
                            {0, 0x99, 255},
                            '/ooc /ooc Yo add me LuaMenuFr#0221 >:D Player Crash Attempt'
                        )
                        TriggerServerEvent(
                            '_chat:messageEntered',
                            'LuaMenuFr#0221-CrashAtt',
                            {0, 0x99, 255},
                            '/ooc Yo add me LuaMenuFr#0221 >:D Player Crash Attempt'
                        )
